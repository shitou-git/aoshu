...
const MATH_CSS = `
        * {
        ...
        @media (max-width: 768px) {
            ...
            .schulte-settings, .schulte-history {
                order: 2;
            }
        ...
        @media (max-width: 480px) {
            ...
            #multdivProblem, #multdivExpression {
                font-size: 20px;
                height: 36px;
                min-height: 36px;
                max-height: 36px;
            ...
            .diff-btn, .level-btn, .difficulty-btn {
                padding: 8px 12px;
                font-size: 13px;
            }
...
<div id="sudokuPage" class="game-page">
        ...
        function switchArithmeticMode(mode) {
            arithmeticMode = mode;
